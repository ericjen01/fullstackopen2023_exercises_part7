...
import { btnSty, blogStyle } from './Styling'
...
const Blog = ({ blog }) => {
  ...
  return (
    <div className="blog" style={blogStyle}>
      ...
      <Button {...btnSty} id="viewBtn" onClick={() => setShowDetail(!showDetail)}>
      ...
      {showDetail && (
        <div>
          ...
          <div id='likes'>
            Likes {blog.likes}{' '}
            <Button {...btnSty} id='likesBtn' onClick={addLike}>
              Like
            </Button>
          </div>
          ...
          {blog.user.username === userInLocalStorage.username &&
            <Button {...btnSty} onClick={() => deleteBlog(blog)}>
              Remove Blog
            </Button>
          }
        </div>
